  ...
  return (
    ...
    <Drawer
      ...
      >
        ...
        <Divider />
        <List>
          {['About me', 'Freebies', 'Blog', 'Contact'].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>
                {index % 2 === 0 ? <InboxIcon /> : <MailIcon />}
              </ListItemIcon>
    ...
    <main style={pageStyles}>
      ...
      <div style={title}>
        ...
        <div style={title2}>
          <ul style={navlist}>
            <li style={tabs}>Home</li>
            <li style={tabs}>About me</li>
            <li style={tabs}>Freebies</li>
            <li style={tabs}>Blog</li>
            <li style={tabs}>Contact</li>
          </ul>
        </div> 
        : <IconButton
            color="inherit"
      ...
      <div style={colone}>
        <div style={desc}>
          <h1 style={headingStyles}>
            Hi, Welcome!
            <br />
            <span style={headingAccentStyles}> About Page </span> <br/>
